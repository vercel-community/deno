...
| `DENO_VERSION`  | Version of `deno` that the serverless function will use.                                                                                                                                 | `1.2.3` |
